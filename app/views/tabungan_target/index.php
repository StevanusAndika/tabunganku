...
<html lang="en">
  <head>
    ...
    <title><?= APP_NAME ?> | Kakulator Target </title>
    <!-- plugins:css -->
 ...
 .skeleton {
  ...
  <body class="with-welcome-text">
    ...
    <div class="page-header">
            ...
            <h2 class="page-title">Kakulator Target</h2><br>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-striped" id="kategoriTable">
            ...
            <th class="sortable" onclick="sortTable(8)"> Aksi<i class="mdi mdi-swap-vertical"></i></th> <!-- Kolom angka -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="detailContent">
        <!-- Detail content will be inserted via JS -->
      </div>
    </div>
  </div>
</div>
        ...
        .then(data => {
          if (data.error) {
            ...
            document.getElementById('detailContent').innerHTML = `
              <p><strong>Nama:</strong> ${data.nama_target}</p>
              <p><strong>Nominal:</strong> Rp ${parseInt(data.nominal_target).toLocaleString()}</p>
              <p><strong>Per ${data.metode_menabung}:</strong> Rp ${parseInt(data.hasil_kalkulasi).toLocaleString()}</p>
              <p><strong>Dimulai:</strong> ${data.tanggal_dimulai}</p>
              <p><strong>Berakhir:</strong> ${data.tanggal_berakhir}</p>
            `;
